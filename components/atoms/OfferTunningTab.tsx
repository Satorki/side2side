...
const OfferTunningTab = ({
  ...
  return (
    <div className="flex gap-4 font-bai md:max-w-[250px] shadow-md rounded-2xl hover:scale-95 transition-all ease-in-out duration-300 p-4 bg-[var(--color-background1)]">
