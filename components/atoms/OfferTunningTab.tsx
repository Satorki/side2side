...
const OfferTunningTab = ({
  ...
  return (
    <div className="flex flex-col gap-2 font-bai md:max-w-[250px] shadow-xl rounded-2xl hover:scale-95 transition-all ease-in-out duration-300 cursor-pointer p-4 bg-[#323232] w-full">
